export const CONTRACT_ADDRESS = '0x6C50A558B6378bDDD6FAEd1d1C7f3aC153aeDe7A' as `0x${string}`;
export const GOLD_COIN_ADDRESS = '0x500ab2488b377DD9329CBdb5414AC9108781421E' as `0x${string}`;
...
export const CONTRACT_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract GoldCoin",
        "name": "",
        "type": "address"
      }
    ],
...
// ABI copied from deployments/sepolia/GoldCoin.json
export const GOLD_COIN_ABI = [
  {
    "inputs": [],
    "stateMutability": "nonpayable",
    "type": "constructor"
